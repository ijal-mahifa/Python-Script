        ...
        for info in data['productInfo']:
            try:
                data_dict = {
                    ...
                    'genders': str(info['merchProduct']['genders'])[1:len(str(info['merchProduct']['genders'])) - 1],
                    'sportTags': str(info['merchProduct']['sportTags'])[1:len(str(info['merchProduct']['sportTags'])) - 1],
